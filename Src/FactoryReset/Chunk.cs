...
namespace GameManager
{
    class Chunk
    {
                    ...
                    if (Enum.IsDefined(typeof(Colors), tile))
                    {
                        ...
                        switch (tile)
                        {
                            ...
                            case (uint)Colors.DialogTrigger:
                                ...
                                break;
                            case (uint)Colors.AlarmTrigger:
                                CollidingEntities.Add(new AlarmTrigger(position, Game));
                                break;
                        }
                    }
        ...
        public int MyClamp(int val, int min, int max)
        {
        ...
        {
            x = MyClamp(x, 0, (int)Width - 1);
            y = MyClamp(y, 0, (int)Height - 1);
