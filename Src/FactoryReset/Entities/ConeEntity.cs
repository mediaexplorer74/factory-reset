...
namespace GameManager
{
    class ConeEntity : Entity
    {
        ...
        public static readonly Color ClearColor = new Color(0, 0.3F, 0.5F, 0.1F);
        public static readonly Color AlertColor = new Color(1, 0, 0, 0.1F);
        public static readonly Color InspectColor = new Color(0.7F, 0.7F, 0, 0.1F);
