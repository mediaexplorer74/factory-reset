...
namespace GameManager
{
    public class SpriteEngine
    {
        ...
        public void LoadContent(ContentManager content)
        {
            ...
            {
                // Safe fallback
                TileEffect = new BasicEffect(Game.GraphicsDevice)
                {
                    TextureEnabled = true,
                    VertexColorEnabled = false
                };
                Debug.WriteLine("[ex] SpriteEngine: " + ex.Message);
            }
        }
        ...
        public void Draw(Texture2D texture, Vector4 source)
        {
            ...
            TileEffect.Parameters["tilesetSize"].SetValue(new Vector2(texture.Width, texture.Height));
